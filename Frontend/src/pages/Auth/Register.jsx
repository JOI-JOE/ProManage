...
const Register = () => {
  ...
  <div className="w-full max-w-[525px] bg-white rounded-lg p-10 text-center shadow-lg">
    ...
    <form onSubmit={handleRegister}>
      ...
      <input type="password" placeholder="Password Confirmation" name="password_confirmation" onChange={handleChange}
        className="w-full border rounded-md p-3 mb-3" />
      {errors.password_confirmation && <p className="text-red-500 text-sm">{errors.password_confirmation[0]}</p>}

      <button type="submit" className="w-full bg-indigo-500 text-white p-3 rounded-md hover:bg-indigo-700">
        Register
      </button>
    </form>
