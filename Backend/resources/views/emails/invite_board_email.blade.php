          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
              <td style="color: #153643; font-size: 24px; font-weight: bold; text-align: left; padding: 10px 0 15px 0;">
                 Bạn được mời tham gia bảng "{{ $boardName }}"
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 0 0 25px 0; color: #153643; font-size: 16px; line-height: 24px; text-align: left;">
                Tham gia bảng "{{ $boardName }}" trên Promange để cộng tác và quản lý công việc hiệu quả.
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding-bottom: 30px;">
                <a href="{{ $inviteLink }}" style="background-color: #0052cc; color: #ffffff; padding: 15px 30px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold; font-size: 16px;">
                  Tham gia bảng
                </a>
              </td>
            </tr>
